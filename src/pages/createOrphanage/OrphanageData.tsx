...
export default function OrphanageData() {
  ...
  async function handleImageSelection(){
    ...
    if (status !== 'granted'){
      alert('É necessário acesso à galeria para inserir imagens');
      return;
    }
    ...
    const { uri: image } = result; //renaming destructured variable

    setImages([...images, image]) //incrementing change
